...
static const _ButtonEvent_type_support_symbol_names_t _ButtonEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wildfire_msgs, msg, ButtonEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wildfire_msgs, msg, ButtonEvent)),
  }
};
...
{
  return &::wildfire_msgs::msg::rosidl_typesupport_cpp::ButtonEvent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wildfire_msgs, msg, ButtonEvent)() {
  return get_message_type_support_handle<wildfire_msgs::msg::ButtonEvent>();
}
