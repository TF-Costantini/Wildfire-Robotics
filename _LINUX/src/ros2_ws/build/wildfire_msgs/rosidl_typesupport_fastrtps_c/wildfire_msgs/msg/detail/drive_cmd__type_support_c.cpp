...
#include "wildfire_msgs/msg/detail/drive_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _DriveCmd__ros_msg_type = wildfire_msgs__msg__DriveCmd;
...
size_t get_serialized_size_wildfire_msgs__msg__DriveCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DriveCmd__ros_msg_type * ros_message = static_cast<const _DriveCmd__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DriveCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wildfire_msgs__msg__DriveCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_wildfire_msgs
size_t max_serialized_size_wildfire_msgs__msg__DriveCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wildfire_msgs__msg__DriveCmd;
    is_plain =
      (
...
static size_t _DriveCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wildfire_msgs__msg__DriveCmd(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wildfire_msgs, msg, DriveCmd)() {
