...
#include "wildfire_msgs/msg/detail/drive_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wildfire_msgs::msg::DriveCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wildfire_msgs::msg::DriveCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wildfire_msgs::msg::DriveCmd *>(
    untyped_ros_message);
...
{
  return &wildfire_msgs::msg::typesupport_fastrtps_cpp::_DriveCmd__handle;
}
