...
{
  new (message_memory) wildfire_msgs::msg::Mode(_init);
}

void Mode_fini_function(void * message_memory)
{
  auto typed_message = static_cast<wildfire_msgs::msg::Mode *>(message_memory);
  typed_message->~Mode();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Mode_message_member_array[2] = {
  {
    ...
    offsetof(wildfire_msgs::msg::Mode, mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wildfire_msgs::msg::Mode, stamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::wildfire_msgs::msg::rosidl_typesupport_introspection_cpp::Mode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wildfire_msgs, msg, Mode)() {
  return &::wildfire_msgs::msg::rosidl_typesupport_introspection_cpp::Mode_message_type_support_handle;
}
