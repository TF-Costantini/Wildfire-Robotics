...
class Metaclass_ButtonEvent(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'PRESS': cls.__constants['PRESS'],
            'RELEASE': cls.__constants['RELEASE'],
            'LONG_PRESS': cls.__constants['LONG_PRESS'],
        }

    @property
    def PRESS(self):
        """Message constant 'PRESS'."""
        return Metaclass_ButtonEvent.__constants['PRESS']

    @property
    def RELEASE(self):
        """Message constant 'RELEASE'."""
        return Metaclass_ButtonEvent.__constants['RELEASE']

    @property
    def LONG_PRESS(self):
        """Message constant 'LONG_PRESS'."""
        return Metaclass_ButtonEvent.__constants['LONG_PRESS']
