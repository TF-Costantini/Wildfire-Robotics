...
#include "wildfire_msgs/msg/detail/button_event__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wildfire_msgs::msg::ButtonEvent & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wildfire_msgs::msg::ButtonEvent & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wildfire_msgs::msg::ButtonEvent;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wildfire_msgs::msg::ButtonEvent *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wildfire_msgs::msg::ButtonEvent *>(
    untyped_ros_message);
...
{
  return &wildfire_msgs::msg::typesupport_fastrtps_cpp::_ButtonEvent__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wildfire_msgs, msg, ButtonEvent)() {
  return &wildfire_msgs::msg::typesupport_fastrtps_cpp::_ButtonEvent__handle;
}
