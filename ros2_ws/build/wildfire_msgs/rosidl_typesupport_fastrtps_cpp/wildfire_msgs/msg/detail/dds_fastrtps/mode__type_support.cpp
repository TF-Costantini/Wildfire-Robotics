...
#include "wildfire_msgs/msg/detail/mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wildfire_msgs::msg::Mode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wildfire_msgs::msg::Mode & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wildfire_msgs::msg::Mode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wildfire_msgs::msg::Mode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wildfire_msgs::msg::Mode *>(
    untyped_ros_message);
...
{
  return &wildfire_msgs::msg::typesupport_fastrtps_cpp::_Mode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wildfire_msgs, msg, Mode)() {
  return &wildfire_msgs::msg::typesupport_fastrtps_cpp::_Mode__handle;
}
