...
bool wildfire_msgs__msg__button_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wildfire_msgs.msg._button_event.ButtonEvent", full_classname_dest, 43) == 0);
  }
  wildfire_msgs__msg__ButtonEvent * ros_message = _ros_message;
  {  // stamp
...
PyObject * wildfire_msgs__msg__button_event__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("wildfire_msgs.msg._button_event");
